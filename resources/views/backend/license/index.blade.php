...
<div class="container mt-5">
    <div class="alert alert-warning d-flex align-items-center" role="alert">
        ...
        <div>
            <strong>Giấy phép sử dụng của bạn sắp hết hạn!</strong>
            ...
            <a target="_blank" href="https://www.tiny.cloud/" class="btn btn-primary">Gia hạn ngay</a>
        </div>
    </div>
    ...
    <div class="alert alert-warning d-flex align-items-center mt-4" role="alert">
        ...
        <div>
            ...
            <a target="_blank" href="{{ route('client.home') }}" class="btn btn-primary">Về trang chủ</a>
        </div>
    </div>
