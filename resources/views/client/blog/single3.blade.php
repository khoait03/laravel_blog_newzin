        ...
        <section class="tc-main-post-style1 pb-60">
            <div class="container">
                            ...
                            <div class="author-side color-666 fsz-13px">
                                <div class="author me-40 d-flex d-lg-inline-flex align-items-center">
                                    <span class="icon-30 rounded-circle overflow-hidden me-10">
                                        <img src="{{ asset('assets/client/img/colums.png') }}" alt="">
                                    </span>
                                    <span>By</span>
                ...
                <div class="tc-main-post-img img-cover mb-50">
                    <img src="{{ asset('assets/client/img/main_post.jpg') }}" alt="">
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="content border-1 border-top border-bottom brd-gray pt-50 pb-50">
                            <a href="#" class="d-block img-cover">
                                <img src="{{ asset('assets/client/img/banner18.png') }}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="tc-main-post-content">
                            ...
                            <p class="info-text">
                                That immediately brought to mind one of <a href="#" class="text-decoration-underline text-cyan">my fondest</a> memories, involving my daughter
                            </p>
                            <div class="video-content mt-60">
                                <video width="100%" height="100%" controls>
                                    <source src="{{ asset('assets/client/img/video.mp4') }}" type="video/mp4">
                                </video>
                            </div>
                                    ...
                                    <div class="tc-post-grid-default">
                                        <div class="item">
                                            <div class="img img-cover th-250">
                                                <img src="{{ asset('assets/client/img/another_news/1.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="items">
                                                ...
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="{{ asset('assets/client/img/another_news/2.png') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                                            ...
                                            <a href="page-single-post-creative.html" class="item d-block border-1 border-top border-bottom-0 brd-gray pt-15 brd-gray">
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="{{ asset('assets/client/img/another_news/3.png') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col-12 border-1 border-end brd-gray">
                                    <div class="tc-post-grid-default">
                                        <div class="item">
                                            <div class="img img-cover th-250">
                                                <img src="{{ asset('assets/client/img/latest/124.png') }}" alt="">
                                            </div>
                                            <div class="content pt-20">
                                                <a href="#" class="news-cat color-999 fsz-13px text-uppercase mb-10">sport</a>
                                                <h4 class="title ltspc--1 mb-10">
                                        ...
                                        <div class="items">
                                            <a href="page-single-post-creative.html" class="item d-block border-1 border-top border-bottom-0 brd-gray pt-15 mt-15 brd-gray">
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="{{ asset('assets/client/img/latest/123.png') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                                            ...
                                            <a href="page-single-post-creative.html" class="item d-block border-1 border-top border-bottom-0 brd-gray pt-15 brd-gray">
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="{{ asset('assets/client/img/latest/130.png') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="tc-post-grid-default">
                                        <div class="item">
                                            <div class="img img-cover th-250">
                                                <img src="{{ asset('assets/client/img/latest/137.png') }}" alt="">
                                            </div>
                                            <div class="content pt-20">
                                        ...
                                        <div class="items">
                                            <a href="page-single-post-creative.html" class="item d-block border-1 border-top border-bottom-0 brd-gray pt-15 mt-15 brd-gray">
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="{{ asset('assets/client/img/latest/132.png') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                                            ...
                                            <a href="page-single-post-creative.html" class="item d-block border-1 border-top border-bottom-0 brd-gray pt-15 brd-gray">
                                                <div class="row gx-3 align-items-center">
                                                    <div class="col-4">
                                                        <div class="img th-70 img-cover">
                                                            <img src="{{ asset('assets/client/img/latest/131.png') }}" alt="">
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="content">
                            ...
                            <div class="content">
                                ...
                                <div class="comments-cards">
                                    <div class="comment-replay-cont border-bottom border-1 brd-gray pb-40 pt-40">
                                        <div class="d-flex comment-cont">
                                            <div class="icon-60 rounded-circle img-cover overflow-hidden me-3 flex-shrink-0">
                                                <img src="{{ asset('assets/client/img/colums/1.png') }}" alt="">
                                            </div>
                                            <div class="inf w-100">
                                        ...
                                        <div class="d-flex comment-replay ps-5 mt-30 ms-4">
                                            <div class="icon-40 rounded-circle img-cover overflow-hidden me-3 flex-shrink-0">
                                                <img src="{{ asset('assets/client/img/colums/2.png') }}" alt="">
                                            </div>
                                            <div class="inf w-100">
                                                <div class="title d-flex justify-content-between">
                                    ...
                                    <div class="comment-replay-cont pb-40 pt-40 border-bottom border-1 brd-gray">
                                        <div class="d-flex comment-cont">
                                            <div class="icon-60 rounded-circle img-cover overflow-hidden me-3 flex-shrink-0">
                                                <img src="{{ asset('assets/client/img/colums/3.png') }}" alt="">
                                            </div>
                                            <div class="inf w-100">
                                                <div class="title d-flex justify-content-between">
        ...
        <!-- ====== start modals ====== -->
         ...
         <div class="offcanvas offcanvas-start sidebar-popup-style1" tabindex="-1" id="offcanvasExample"
            ...
            <div class="offcanvas-header">
                <div class="logo">
                    <img src="{{ asset('assets/client/img/logo_home1.png') }}" alt="" class="dark-none">
                    <img src="{{ asset('assets/client/img/logo_home1_lt.png') }}" alt="" class="light-none">
                </div>
